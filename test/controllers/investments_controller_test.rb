...
class InvestmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post investments_url, params: { investment: { account_id: @investment.account_id, amount: @investment.amount, interes: @investment.interes, meses: @investment.meses } }
    end
  ...
  test "should update investment" do
    patch investment_url(@investment), params: { investment: { account_id: @investment.account_id, amount: @investment.amount, interes: @investment.interes, meses: @investment.meses } }
